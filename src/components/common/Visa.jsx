...
const Visa = () => {
  ...
  return (
    <div className=' container max-w-[1164px] mx-auto px-3 '>
      <div className=' transform translate-y-[134px] max-sm:translate-y-[150px] py-16 max-md:py-10 max-sm:py-5 max-md:px-5 bg-btnOrange rounded-[8px] flex justify-center '>

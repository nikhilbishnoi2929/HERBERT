...
const Resources = () => {
  return (
    <>
      {/* <div className='pt-[142px] pb-[106px]'>
        <div className='max-w-[1290px] px-3 mx-auto'>
          <div className=" flex flex-row flex-wrap">
            <div className='lg:w-6/12 md:w-6/12 w-full px-4 '>
              <div className=''>
                <div className='flex flex-col max-w-[473px] '>
                  <h2 className='max-w-[473px] font-semibold text-5xl leading-[56px] text-black pb-4'>Team <span className='text-orange'>&</span>  Resources</h2>
                  <p className='max-w-[473px] text-gray font-lato font-normal text-xs leading-[24px]'>Lorem ipsum dolor sit amet consectetur. Tellus ipsum semper eget ornare justo netus proin lacus sed. Vulputate eget lectus vitae iaculis rhoncus.
                ...
                <div className='flex flex-col items-start justify-start'>
                  <div className="flex items-center justify-center gap-2">
                    <div className="bg-gray rounded-full size-2"></div>
                    <p className='max-w-[473px] text-gray font-lato font-normal text-xs leading-[24px] '>Single entrepreneur (yourself)</p>
                  </div>
                  <div className="flex items-center justify-center gap-2">
                    <div className="bg-gray rounded-full size-2"></div>
                    <p className='max-w-[473px] text-gray font-lato font-normal text-xs leading-[24px] '>Outsourced development to freelancers</p>
                  </div>
                  <div className="flex items-center justify-center gap-2">
                    <div className="bg-gray rounded-full size-2"></div>
                    <p className='max-w-[473px] text-gray font-lato font-normal text-xs leading-[24px] '>Budget: $15,000 </p>
                  </div>
            ...
            <div className='lg:w-6/12 md:w-6/12 w-full  px-3'>
              <div className='relative'>
                <img src={team_Img} alt="team_Img" className='w-full xl:max-w-[701px] left-[100px]  lg:left-[70px] absolute' />
              </div>

    ...
    <div className=' container max-w-[1164px] px-3 mx-auto'>
      <div className='flex flex-wrap flex-row -mx-[12px] items-center xl:transform xl:-translate-y-[108px] sm:py-5 max-lg:justify-center'>
        {INTER_ACTIVE.map((obj, index) => (
          <div className='cardInteractive min-h-[238px] lg:w-4/12 md:w-6/12 w-full px-3 max-lg:pt-4 max-lg:justify-center max-lg:flex '  key={index} >
            <div className='z-20 md:max-w-[364px] w-full rounded-[8px] hover:border-0 custom_Duration hover:shadow-card_Shadow bg-white border-[1px] lg:hover:py-[41px] lg:hover:-mt-[21px] duration-300 border-[#00000029] py-[20px] max-sm:py-[22px]'>
